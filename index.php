					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> vuhaile797@gmail.com</a></li>
							</ul>
						</div>
					</div>				
				</div>
				...
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            <a href="index.php" style="background-color:White; color:Black" >StoreToy
                            <img src="img/h22.jpg" width="80" height="80"></a>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav" >
                            <!-- <li><a href="Cart.php" style="background-color: #555555; color:#FFF">
                            <i class="fa fa-shopping-cart">Cart</i></a></li>              -->
                                <?php
                                ...
                                <?php
                                    ...
                                    {                               
                                ?>
                                <li><a href="?page=login" style="background-color:#555555;color:#FFF">
                                <i class="fa fa-lock"></i>Login</a></li>
                                <li><a href="?page=register" style="background-color:#555555;color:#FFF">
